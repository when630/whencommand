...
**v0.1.4 공개(2026-09-21)** — `github.com/when630/whencommand/releases`. v0.1.0(첫 릴리스) 같은 날 v0.1.1(아이콘·한글 별칭)·v0.1.2(설정 창 사용법·스크롤, D-25)·v0.1.3(형제 앱 실제 아이콘, D-26)·v0.1.4(그림자·두 번 깜빡임, D-27). Windows NSIS + macOS dmg/zip(arm64·x64), CI 세 OS. macOS는 실기기 검증 전.
